	...
	return /** @lends CKEDITOR.theme */ {
		...
		buildDialog : function( editor )
		{
			...
			var element = CKEDITOR.dom.element.createFromHtml( [
					'<div class="', editor.id, '_dialog cke_editor_', editor.name.replace('.', '\\.'), '_dialog ',
						'" dir="', editor.lang.dir, '"' +
						' lang="', editor.langCode, '"' +
						' role="dialog"' +
						' aria-labelledby="%title#"' +
						'>' +
						'<table class="ui-dialog ui-widget ui-widget-content ui-corner-all ui-draggable ', ' ' + CKEDITOR.env.cssClass,
							' cke_', editor.lang.dir, '" style="position:absolute" role="presentation">' +
							'<tr><td role="presentation">' +
							'<div class="%body" role="presentation">' +
								'<div id="%title#" class="%title ui-dialog-titlebar ui-widget-header ui-corner-all ui-helper-clearfix" role="presentation">' +
								    '<a id="%close_button#" class="ui-dialog-titlebar-close ui-corner-all" href="javascript:void(0)" title="' +  editor.lang.common.close+'" role="button"><span class="ui-icon ui-icon-closethick">X</span></a>' +
								'</div>' +
							...
							'<div id="%tc#" class="%tc" style="display: none;"></div>' +
							'<div id="%tr#" class="%tr" style="display: none;"></div>' +
							'<div id="%ml#" class="%ml" style="display: none;"></div>' +
							'<div id="%mr#" class="%mr" style="display: none;"></div>' +
							'<div id="%bl#" class="%bl" style="display: none;"></div>' +
							'<div id="%bc#" class="%bc" style="display: none;"></div>' +
							'<div id="%br#" class="%br" style="display: none;"></div>' +
							'</td></tr>' +
						'</table>',
			...
			return {
				...
				parts :
				{
					...
					title		: title,
                    close       : close,
					tabs		: body.getChild( 1 ),
					contents	: body.getChild( [ 2, 0, 0, 0 ] ),
					footer		: body.getChild( 3 )
				}
			};
		},
