...
'path'					=>	'Basepath to the LibrarEE File Directory <div class="subtext">Server path to the directory in which the snippets/specialty templates/global variables files should be saved. Corresponding folders will be created here.<br/>When using relative paths, set the path relative to '.$_SERVER['DOCUMENT_ROOT'].'</div>',
'tmpl_path'				=>	'Basepath to Template File Directory .<div class="subtext">If you are using a configuration bootstrap file, please adjust your path there if necessary.</div>',
'license_key'			=>	'License key for this domain',
'invalid_license_key'	=>	'The supplied license key is invalid.',
'snippets_path'			=>	'Path to your snippets folder which will be available for your current site and all MSM sites',
...
"create_folder_error"	=> "LibrarEE says: Please make sure your folder is writeable. You must set the following folder to 777 (or equivalent write permissions on your server): ",
...
"user_message_parsing_enabled" => "Enable parsing of system messages <div class='subtext'>Will allow you to design error message, user messages, offline template like you would design any other template.",

"user_email_parsing_enabled" => "Enable parsing of HTML user notification emails <div class='subtext'>Will allow you to design email templateslike you would design any other template.",
