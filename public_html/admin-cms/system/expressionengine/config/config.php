...
$config['app_version'] = '2.10.2';
$config['license_contact'] = 'chris@mailinator.com';
$config['license_number'] = '6774-6594-2598-4347';
$config['debug'] = '1';
$config['cp_url'] = 'http://admin.fennyengineering.com/admin.php';
