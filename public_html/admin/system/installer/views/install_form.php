...
<h5><?=lang('password')?></h5>
<p><?=lang('5_chars')?></p>
<p><input type='password' id='password' name='password' value='<?=$password?>' size='40' maxlength="<?=PASSWORD_MAX_LENGTH?>" class='input' /></p>

<h5><?=lang('password_confirm')?></h5>
<p><?=lang('pw_retype')?></p>
<p><input type='password' id='password_confirm' name='password_confirm' value='<?=$password_confirm?>' size='40' maxlength="<?=PASSWORD_MAX_LENGTH?>" class='input' onkeyup="confirm_password();return false;"/></p>
