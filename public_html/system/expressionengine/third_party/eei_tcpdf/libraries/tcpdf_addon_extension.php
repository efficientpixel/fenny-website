<?php if(!defined('BASEPATH')) exit('No direct script access allowed');
  ...
  */
   ...
   */
  class TCPDF_ADDON_EXTENSION extends TCPDF
  {
    // --------------------------------------------------------------------
  ...
  /* End of file tcpdf_addon_extension.php */
  /* Location: ./system/expressionengine/third_party/eei_tcpdf/libraries/tcpdf_addon_extension.php */