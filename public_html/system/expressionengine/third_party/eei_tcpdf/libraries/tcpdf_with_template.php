<?php if(!defined('BASEPATH')) exit('No direct script access allowed');
  ...
  */
   ...
   * @note         FPDI homepage: http://www.setasign.de/products/pdf-php-solutions/fpdi/
   * @todo         New TCPDF class must be monitored if TCPDF::Image() is changed 
   */
  class TCPDF_WITH_TEMPLATE extends FPDI  
  {
    // --------------------------------------------------------------------
    ...
    public function Header() 
    {
      ...
      {
        $this->setSourceFile(PAGE_WITH_PDF_TEMPLATE);
  ...
  /* End of file tcpdf_with_template.php */
  /* Location: ./system/expressionengine/third_party/eei_tcpdf/libraries/tcpdf_with_template.php */