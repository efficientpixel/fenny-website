...
class Expressionengine_info_acc {
	...
	function _fetch_resources()
	{
		return '
		<ul>
			<li><a href="'.ee()->cp->masked_url('https://docs.expressionengine.com/v2/').'">'.lang('documentation').'</a></li>
			<li><a href="'.ee()->cp->masked_url('https://ellislab.com/support/').'">'.lang('support_resources').'</a></li>
