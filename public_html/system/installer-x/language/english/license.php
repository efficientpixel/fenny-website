...
*  Standard License: Users of the Standard purchased ExpressionEngine License may use the Software on a website engaging in commercial, personal, non-commercial, or non-profit activities. Websites engaging in direct or indirect commercial activities must purchase a Standard License.

Each installation may be used to power a single website. Using ExpressionEngine to run multiple sites requires a multi-site license, and all such sites must be wholly owned by the licensee.
...
*  Use the Core License for any client or contract work.
...
Core License Users are required to display a “powered by ExpressionEngine” link or graphic on their publicly accessible site, pointing to https://ellislab.com/expressionengine. Users of a purchased Standard license are exempt from this requirement.
...
Except as forbidden by this license agreement, you may alter, modify, or extend the Software for your own use, or commission a third-party to perform modifications for you, but you may not resell, redistribute or transfer the modified or derivative version without prior written consent from EllisLab, Inc. Components from the Software may not be extracted and used in other programs without prior written consent from EllisLab, Inc.
...
Due to the non-returnable nature of downloadable software, EllisLab, Inc. does not issue refunds once a transaction has been completed. If you have questions about whether or not ExpressionEngine will work for you, please try the Core edition or contact us (http://ellislab.com/about) with any questions. We encourage you to thoroughly test the system you are interested in before purchasing to determine its suitability for your purposes and compatibility with your hosting account.
