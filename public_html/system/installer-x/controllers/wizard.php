...
class Wizard extends CI_Controller {
	...
	var $version			= '2.10.3';	// The version being installed
	...
	var $userdata = array(
		'app_version'			=> '',
		'doc_url'				=> 'https://docs.expressionengine.com/v2/',
		'ext'					=> '.php',
		'ip'					=> '',
		'database'				=> 'mysql',
		'db_conntype'			=> '0',
...
PAPAYA;
	...
	function _do_install()
	{
		...
		// Passwords must be no more than 72 chars in length
		if ($this->userdata['password'] != '' AND strlen($this->userdata['password']) > PASSWORD_MAX_LENGTH)
		{
			$errors[] = $this->lang->line('password_long');
		}
